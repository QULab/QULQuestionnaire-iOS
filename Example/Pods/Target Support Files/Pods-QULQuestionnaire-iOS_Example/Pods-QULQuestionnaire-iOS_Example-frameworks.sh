...
install_framework()
{
  local source="${BUILT_PRODUCTS_DIR}/Pods-QULQuestionnaire-iOS_Example/$1"
...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework 'QULQuestionnaire.framework'
  install_framework 'RMStepsController.framework'
fi
